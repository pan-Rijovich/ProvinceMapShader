    ...
    public partial class WMSKEditorInspector : Editor {
        ...
        void ShowEntitySelectors() {
            ...
            if (_editor.editingMode == EDITING_MODE.PROVINCES) {
                ...
                if (selectedProvincesCount > 1) {
                    ...
                    _editor.showProvinceNames = EditorGUILayout.Toggle("Show Province Labels", _editor.showProvinceNames);
        ...
        void ShowReshapingRegionTools() {
            ...
            if (_editor.reshapeRegionMode.hasCircle()) {
                _editor.reshapeCircleWidth = EditorGUILayout.Slider("Circle Width", _editor.reshapeCircleWidth, 0.001f, 0.1f);
            }
            ...
            switch (_editor.reshapeRegionMode) {
                case RESHAPE_REGION_TOOL.CIRCLE:
                    _editor.circleMoveConstant = EditorGUILayout.Toggle("Constant Move", _editor.circleMoveConstant);
                    break;
                case RESHAPE_REGION_TOOL.MAGNET:
                    _editor.magnetAgressiveMode = EditorGUILayout.Toggle("Agressive Mode", _editor.magnetAgressiveMode);
                    _editor.magnetIncludeCountries = EditorGUILayout.Toggle("Include Countries", _editor.magnetIncludeCountries);
                    break;
        ...
        void ExecuteMoveTool(Vector2 mousePosition) {
            ...
            for (int i = 0; i < points.Length; i++) {
                ...
                var fmh_1821_61_638606192387883446 = mapTransform.rotation; newPoint = Handles.FreeMoveHandle(oldPoint, handleSize, pointSnap,
        ...
        void ExecuteCityMoveTool() {
            ...
            var fmh_2000_65_638606192388071521 = mapTransform.rotation; Vector3 newPoint = Handles.FreeMoveHandle(oldPoint, handleSize, pointSnap,
                                                   (handleControlID, position, rotation, size, eventType) => {
        ...
        void ExecuteMountPointMoveTool() {
            ...
            var fmh_2086_65_638606192388088696 = mapTransform.rotation; Vector3 newPoint = Handles.FreeMoveHandle(oldPoint, handleSize, pointSnap,
                                                                   (handleControlID, position, rotation, size, eventType) => {
                                                                       Handles.RectangleHandleCap(handleControlID, position, rotation, size, eventType);
                                                                   });
            if (newPoint != oldPoint) {
